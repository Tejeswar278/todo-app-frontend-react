	...
	const vital_tasks_list = [
		{
			...
			"objective":"To attend Nischal's birthday party and meet neha in-person",
			"deadline":"By EOD"
		},
		{
	...
	return (
		<div className='flex w-full gap-3'>
			<div className='border-2 border-gray-300 shadow-xl w-1/2 rounded-2xl py-4'>
				<div className='font-bold ps-4 mb-4'><span className='underline decoration-2 underline-offset-4 decoration-red-500'>My</span> Tasks</div>
				<div>
			...
			<div className='border-2 border-gray-300 shadow-xl w-1/2 rounded-2xl flex flex-col justify-between'>
				<div>
					...
					<div className='p-4 text-gray-500'>
						<div>
							<span className='font-semibold'>Task Title:</span><p>{selectedTask.title}</p>
						</div>
						<div>
							<span className='font-semibold'>objective:</span><p>{selectedTask.objective}</p>
						</div>
						<div>
							<span className='font-semibold'>Task Description:</span><p>{selectedTask.description}</p>
						</div>
						<div>
							<span className='font-semibold'>Additional Notes:</span><p>{selectedTask.additional_notes}</p>
						</div>
						<div>
							<span className='font-semibold'>Deadline for submissions:</span><p>{selectedTask.deadline}</p>
						</div>
					</div>
				</div>
